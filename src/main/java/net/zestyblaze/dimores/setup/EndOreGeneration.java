...
public class EndOreGeneration {
    ...
    public static ConfiguredFeature<?, ?> END_QUARTZ_ORE = Feature.ORE
            .configure(new OreFeatureConfig(
                    new BlockMatchRuleTest(Blocks.END_STONE),
                    EndOres.END_QUARTZ.getDefaultState(),
                    24
            ))
            .range(new RangeDecoratorConfig(
                    UniformHeightProvider.create(YOffset.fixed(10), YOffset.fixed(117))
            ))
            .spreadHorizontally()
            .repeat(16);

    public static ConfiguredFeature<?, ?> END_ANCIENT_DEBRIS = Feature.ORE
            .configure(new OreFeatureConfig(
                    new BlockMatchRuleTest(Blocks.END_STONE),
            ...
            .range(new RangeDecoratorConfig(
                    UniformHeightProvider.create(YOffset.fixed(8), YOffset.fixed(28))
            ))
            .spreadHorizontally()
            .repeat(5);
    ...
    public static void generateOres() {
        {
            RegistryKey<ConfiguredFeature<?, ?>> endCoalOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_coal_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endIronOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_iron_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endCopperOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_copper_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endGoldOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_gold_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endLapisOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_lapis_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endRedstoneOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_redstone_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endDiamondOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_diamond_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endEmeraldOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_emerald_ore"));
            ...
            RegistryKey<ConfiguredFeature<?, ?>> endAncientDebris = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_ancient_debris"));
            Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, endAncientDebris.getValue(), END_ANCIENT_DEBRIS);
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, endAncientDebris);

            RegistryKey<ConfiguredFeature<?, ?>> endQuartzOre = RegistryKey.of(Registry.CONFIGURED_FEATURE_KEY,
                    new Identifier(DimOres.MOD_ID, "end_quartz_ore"));
            Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, endQuartzOre.getValue(), END_QUARTZ_ORE);
            BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(), GenerationStep.Feature.UNDERGROUND_ORES, endQuartzOre);
        }
    }
}
